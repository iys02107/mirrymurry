...
public class BookService {
    ...
    public boolean newBook(BookFormDto bookFormDto, Principal principal){
        ...
        Book book = new Book(bookFormDto,currentMember.getMember_id());
    ...
    public List<BookHistDto> getBookHistList(Integer member_id){
        List<BookHistDto> bookHistDtoList = bookMapper.bookHistDtoList(member_id);
        return bookHistDtoList;
    }
}
