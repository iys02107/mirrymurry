...
public class Member {
    ...
    public Member(Integer member_id, String email, String password, String user_name, Role role, String postcode, String road_address, String detail_address, String phone_number, Double longitude, Double latitude) {
    ...
    public void updateMember(StoreFormDto memberFormDto, Integer member_id){
        this.member_id = member_id;
        this.email = memberFormDto.getEmail();
        this.user_name = memberFormDto.getUser_name();
        this.phone_number = memberFormDto.getPhone_number();
